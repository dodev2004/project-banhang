...
<div class="wrapper wrapper-content animated fadeInRight">
    <form action="{{route("admin.users.store")}}" method="POST" class="form_user_catelogue_edit" style="background-color: white; padding:40px" novalidate enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-8 " style="padding:20px 0 0 50px">
                <div class="row" style="display: flex; flex-wrap:wrap">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea name="description" id="" cols="30" class="form-control" rows="10">{{$data->description}}</textarea>
...
@include('backend.user.handle.quanlynhomthanhvien.update');
