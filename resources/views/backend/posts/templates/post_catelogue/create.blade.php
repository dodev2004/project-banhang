            ...
            <div class="ibox-content">
                    ...
                    <div class="form-group">
                        <label>Tiêu đề danh mục </label>
                         <input type="text" placeholder="Tiêu đề danh mục" name="name" class="form-control">
                         <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
                        <label>Mô tả ngắn</label>
                        <textarea cols="50" rows="50" class="form-control" name="description" id="editor"></textarea>
                    </div>
                    <div class="form-group">
...
@include("backend.posts.handle.post_catelogue.add");
@endpush